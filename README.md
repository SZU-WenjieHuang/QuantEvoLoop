...
[![CI](https://github.com/yourname/quantevoloop/actions/workflows/ci.yml/badge.svg)](https://github.com/yourname/quantevoloop/actions/workflows/ci.yml)
...
├─────────────────────────────────────────────────────────────┤
│                    Backtest Engines                           │
│         Freqtrade (default)  |  Mock (testing)               │
└─────────────────────────────────────────────────────────────┘
```
...
│   ├── engine/          # BacktestEngine ABC + Freqtrade + Mock
│   ├── evaluation/      # PSR, Bootstrap CI, DSR, Scorer, Diagnostics
...
- [x] CLI + Mock engine + tests
- [ ] Freqtrade engine integration (subprocess BT execution)
- [ ] Real multi-lane parallel execution with asyncio
- [ ] Walk-forward fold execution
- [ ] Web UI dashboard for real-time monitoring
- [ ] Academic paper (experimental results with real strategies)
- [ ] Additional backtest engine adapters (Backtrader, Zipline)
...
@software{quantevoloop2025,
  ...
  year={2025},
  url={https://github.com/yourname/quantevoloop}
}
```
